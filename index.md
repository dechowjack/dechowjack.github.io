...
layout: single
permalink: /
title: "Mountain Snow Hydrology"
classes: wide home-academic
author_profile: false
excerpt: >
  Snow hydrologist and geospatial data scientist studying mountain snow processes,
  remote sensing, and large-scale snow water equivalent modeling.
header:
  overlay_filter: 0.55
  overlay_image: /assets/images/yosemite_winter_nps.png
  caption: "Photo: Yosemite National Park in winter 2023. Photo credit: National Park Service."
  actions:
    - label: "Research"
      url: "/research/"
    - label: "View Publications"
      url: "/publications/"
    - label: "Download CV"
      url: "/assets/files/dechow_cv.pdf"
  overlay_excerpt: >
    Mountain snow hydrologist building large-scale remote sensing and modeling tools
    for snow water equivalent science.
...
<section class="home-sticky-layout">
  ...
  <div class="home-sticky-layout__cards">
    ...
    <article class="theme-card">
      ...
      <p>
        Improving SWE model estimates in complex, mountainous basins where terrain and forcing
        variability challenge coarse-resolution products.
      </p>
    </article>
    <article class="theme-card">
      <h3>Scalable remote sensing workflows</h3>
      <p>
        Developing scalable methods for snow water equivalent estimation from remote sensing and
        remote-sensing-constrained snow models.
      </p>
    </article>
    <article class="theme-card">
      <h3>Climate-sensitive mountain hydrology</h3>
      <p>
        Studying how mountain snowpack dynamics respond to climate variability and how those changes
        shape water resources and cryosphere science.
      </p>
    </article>
  </div>
</section>
